"""changed date to a string in filmshow table model

Revision ID: f0e71798f909
Revises: 5eadda5d4b52
Create Date: 2024-08-25 23:34:12.565137
...
revision: str = 'f0e71798f909'
down_revision: Union[str, None] = '5eadda5d4b52'
...
def downgrade() -> None:
    ...
    sa.Column('SD_Cards', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('Manuals_Given', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('Bibles_Given', sa.INTEGER(), autoincrement=False, nullable=True),
