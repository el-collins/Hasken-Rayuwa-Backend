"""modified the filmshow table model

Revision ID: 846ede27fc08
Revises: cb528be68158
Create Date: 2024-08-24 13:10:16.796244
...
revision: str = '846ede27fc08'
down_revision: Union[str, None] = 'cb528be68158'
...
def downgrade() -> None:
    ...
    sa.Column('SD_Cards', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('Audio_Bibles', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('People_Saved', sa.INTEGER(), autoincrement=False, nullable=False),
